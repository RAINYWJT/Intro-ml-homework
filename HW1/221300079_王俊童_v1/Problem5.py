...
class MyLogisticRegression:
    ...
    def _newton_iterate_step(self, X, y):
        ...
        gradient = self._partial_l(self.beta , X , y)
        hessian = self._partial_2_l(self.beta , X , y)
        new_beta = self.beta - np.linalg.inv(hessian) @ gradient
        # assert 0, "Not implemented!"
